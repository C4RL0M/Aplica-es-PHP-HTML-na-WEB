	...
	<body>
		...
		<hr>
			<form method="post" action="">
				<?php if($dados = mysql_fetch_array($con)) { ?>
				<table>
					<tr>
						<td>Nome:</td>
				...
				<?php
					if(!empty($_POST['nome'])){
						...
						$id = $_GET['id'];
						$sql = mysql_query("UPDATE cliente SET nome='$nome', rua='$rua', numero='$numero', bairro='$bairro', cidade='$cidade', estado='$estado', complemento='$complemento', fone='$fone', email='$email' WHERE id=".$id);
